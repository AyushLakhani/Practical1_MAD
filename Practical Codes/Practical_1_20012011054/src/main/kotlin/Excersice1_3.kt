...
fun main(){
    var s1=Student("Ayush","Lakhani",20,20012011054,"CE","A","AB2")
    var s2=Student("Dhruv","Lakhani",20,20012011055,"CE","C","AB7")
    var s3=Student("Karan","Setia",19,20012011050,"CE","C","AB7")
    var s4=Student("Govind","Naruka",19,20012011046,"CE","B","AB4")
    var s5=Student("Bhavya","Patel",20,20012011079,"CE","C","AB8")
